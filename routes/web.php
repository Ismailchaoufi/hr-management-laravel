...
use App\Http\Controllers\Division\FrontendControllerDivision;
use App\Http\Controllers\Division\ServiceControllerDivision;
use App\Http\Controllers\Division\DemandeControllerDivision;
...
Route::group(['prefix'=>'admin','middleware' => ['auth','isAdmin']], function () {
    ...
    Route::get('/services/{id}', [GestionUserController::class, 'getServicesByDivision'])->name('services.division');
    ...
    Route::get('/conversations/create/{user}', [DiscussionAdminController::class, 'createConversation'])->name('conversations.create');
    ...
    Route::get('/user-profile-pdf/{userId}', [GeneratePDFController::class, 'generateUserProfilePDF'])->name('user-profile-pdf');
 ...
 Route::group(['prefix'=>'fonctionnaire','middleware' => ['auth','isFonctionnaire']], function () {
    ...
    Route::get('demande/word_exportarab/{id}', [DemandeController::class,'WordExportArab'])->name('demande/word_exportarab');
 ...
 Route::group(['middleware' => ['auth']], function () {
    ...
    Route::get('/notifications/details/{id}', [NotificationController::class, 'shownotification'])->name('notifications.details');    
...
//messages public
    ...
    Route::get('gantt/exportbydivision/{id}', [GanttDemande::class, 'generateGanttChartByDivision'])->name('gantt.exportbydivision');
    //check user status
...
Route::group(['prefix'=>'chefdivision','middleware' => ['auth','ischefdivision']], function () {
    Route::get('dashboardchefdivision', [FrontendControllerDivision::class, 'index'])->name('chefdivision.dashboardchefdivision');
    Route::get('services', [ServiceControllerDivision::class, 'index'])->name('chefdivision.services');
    Route::get('demandes', [DemandeControllerDivision::class, 'index'])->name('chefdivision.demandes');
    Route::resource('profilechefdivision', ProfileController::class);
 });
...
//Route::post('/chatgpt', [ChatController::class, 'askChatGPT']);
use App\Http\Controllers\OpenAIController;
Route::post('/ask-question', [OpenAIController::class, 'askQuestion'])->name('ask-question');
Route::post('/chat', [ChatController::class, 'chat']);
use App\Http\Controllers\DialogflowController;
Route::post('/dialogflowchat', [DialogflowController::class, 'handleChat']);