...
//Chef de division
Breadcrumbs::for('chefdivision.dashboardchefdivision', function ($trail) {
    $trail->push('Dashboard', route('chefdivision.dashboardchefdivision'));
});
Breadcrumbs::for('chefdivision.services', function ($trail) {
    $trail->parent('chefdivision.dashboardchefdivision');
    $trail->push('Services', route('chefdivision.services'));
});
Breadcrumbs::for('chefdivision.demandes', function ($trail) {
    $trail->parent('chefdivision.dashboardchefdivision');
    $trail->push('Demandes', route('chefdivision.demandes'));
});
Breadcrumbs::for('profilechefdivision.index', function ($trail) {
    $trail->parent('chefdivision.dashboardchefdivision');
    $trail->push('Profile', route('profilechefdivision.index'));
});
Breadcrumbs::for('notifications.details', function ($trail) {
    $trail->parent('chefdivision.dashboardchefdivision');
    $trail->push('Details de la notification', route('notifications.details'));
});
