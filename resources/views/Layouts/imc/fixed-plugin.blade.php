  ...
  <div class="card shadow-lg">
      <div class="card-header pb-0 pt-3">
          <div class="float-start">
              <h5 class="mt-3 mb-0">Configurateur de Province</h5>
      ...
      <div class="card-body pt-sm-3 pt-0">
          ...
          <p class="text-sm d-xl-none d-block mt-2">Vous pouvez changer le type de barre latérale uniquement en vue bureau.</p>
          <!-- Navbar Fixe -->
