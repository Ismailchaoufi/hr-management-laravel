        ...
        <ul class="navbar-nav">
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdownActualites">
                    <a class="dropdown-item" href="{{ route('news.events') }}">Discussion avec notre Bot</a>
            ...
            @if (Route::has('login'))
                @auth
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('chefdivision.dashboardchefdivision') }}">Revenir à votre tableau de bord Chef Division</a>
                    </li>
