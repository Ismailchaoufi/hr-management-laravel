...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        ...
        <div class="ai-helper-container">
            <button id="ai-helper-redirect">Discussion avec Bot</button>
        </div>
        
        <script>
            document.getElementById('ai-helper-redirect').addEventListener('click', function() {
                window.location.href = '{{ route("news.events") }}';
            });
        </script>
