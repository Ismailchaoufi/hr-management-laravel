        ...
        <div class="card">
            <div class="card-header p-3 pt-2">
                ...
                <div class="text-end pt-1">
                    <p class="text-sm mb-0 text-capitalize">Total des fonctionnaires</p>
            ...
            <div class="card-footer p-3">
                <p class="mb-0">
                    <span class="text-danger text-sm font-weight-bolder">
                        {{ $usersLastMonth }} 
                    </span> fonctionnaires le mois dernier
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
        <div class="card">
            ...
            <div class="card-footer p-3">
                ...
                @else
                    <p class="mb-0"><span class="text-success text-sm font-weight-bolder">0%</span> de total</p>
                @endif
            </div>
        </div>
    </div>
    ...
    <div class="col-xl-3 col-sm-6">
        <div class="card">
            ...
            <div class="card-footer p-3">
                ...
                @else
                <p class="mb-0"><span class="text-danger text-sm font-weight-bolder">0%</span> de total</p>
                @endif
            </div>
        </div>
    </div>
