        ...
        <div class="col-md-3">
            <div class="sidebar bg-light p-3 shadow-sm">
                ...
                <ul class="list-group">
                    ...
                    <li class="list-group-item">
                        <form action="{{ route('users.destroy', $user->id) }}" method="POST" id="delete-user-form-{{ $user->id }}" style="display: inline-block;">
                            @csrf
                            @method('DELETE')
                            <button type="button" class="btn btn-danger btn-block" onclick="confirmDeletion({{ $user->id }})">Supprimer</button>
                        </form>
                    </li>
                    ...
                    <li class="list-group-item">
                        <a href="{{ route('user-profile-pdf', $user->id) }}" class="btn btn-success btn-block">Télécharger Profile PDF</a>
                    </li>
                </ul>
            </div>
        </div>
