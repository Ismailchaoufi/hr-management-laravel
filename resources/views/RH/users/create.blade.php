                        ...
                        <div id="additionalFields" style="display: none;">
                            ...
                            <div class="form-group" style="margin-bottom: 15px;">
                                ...
                                <select name="role" id="role" class="form-control" required>
                                    ...
                                    <!-- Option for Fonctionnaire -->
                                    <option value="0">Fonctionnaire</option>
                            ...
                            <script>
                                document.getElementById('id_division').addEventListener('change', function() {
                                    ...
                                    if (divisionId) {
                                        fetch('/admin/services/' + divisionId)
                                            .then(response => response.json())
                                            .then(services => {
                                                services.forEach(service => {
                                                    var option = document.createElement('option');
                                                    option.value = service.id;
                                                    option.textContent = service.nomFr; // Change to the appropriate field
                            ...
                            <div class="form-group" style="margin-bottom: 15px;">
                                ...
                                <input type="text" name="CNOPS" id="CNOPS" class="form-control" required>
                            </div>

                            <div class="form-group" style="margin-bottom: 15px;">
                                <label for="date_service">Date de Service</label>
                                <input type="date" name="date_service" id="date_service" class="form-control" required>
                            </div>

                            <div class="form-group" style="margin-bottom: 15px;">
                                <label for="numeroPPR">Numéro PPR</label>
                                <input type="text" name="numeroPPR" id="numeroPPR" class="form-control" required>
                            </div>

                            <div class="form-group" style="margin-bottom: 15px;">
                                <label for="date_grade">Date de Grade</label>
                                <input type="date" name="date_grade" id="date_grade" class="form-control"required>
                            </div>

                            <div class="form-group" style="margin-bottom: 15px;">
                                <label for="date_echellon">Date d'Echellon</label>
                                <input type="date" name="date_echellon" id="date_echellon" class="form-control" required>
                            </div>

                            <div class="form-group" style="margin-bottom: 15px;">
                                <label for="mission_respo">Mission Responsable</label>
                                <input type="text" name="mission_respo" id="mission_respo" class="form-control" required>
                            </div>
                            ...
                            <div class="form-group" style="margin-bottom: 15px;">
                                ...
                                <input type="text" name="mutuelle" id="mutuelle" class="form-control"required>
                            </div>
