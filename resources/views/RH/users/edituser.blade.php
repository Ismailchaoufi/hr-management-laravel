        ...
        <form action="{{ route('users.update', $user->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group" style="margin-bottom: 15px;">
                ...
                <select name="role" id="role" class="form-control" required>
                    ...
                    <option value="0" {{ $user->role == 0 ? 'selected' : '' }}>Fonctionnaire</option>
            ...
            <script>
                document.addEventListener('DOMContentLoaded', function() {
                    ...
                    function populateServices(divisionId) {
                            ...
                            fetch('/admin/services/' + divisionId)
                                ...
                                .then(services => {
                                    services.forEach(service => {
                                        ...
                                        option.textContent = service.nomFr;
                                        if (service.id == '{{ $user->id_service }}') {
                    ...
                    // Populate services initially based on the current division
                    var initialDivisionId = divisionSelect.value;
                    populateServices(initialDivisionId);
